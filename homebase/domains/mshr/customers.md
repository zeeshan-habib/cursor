...
|---|---|---|
| Ray Sanza | Chief Revenue Officer (DRI) | Economy-level employment trends to frame Homebase's market narrative and GTM strategy |
| Vlad | Data / Analytics Lead | Metric definitions, table locations, production logic to run and QA the report |
| GTM Team | Marketing / Revenue | Data points and narratives for press releases, sales collateral, and research publications |
| Analytics Analysts | <!-- STUB: add names --> | SQL queries and notebooks to produce the underlying data |
